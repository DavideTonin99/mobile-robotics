...
main_svm(dataset_train=dataset_train, model=model, scaler_model=scaler_model, window_type=WINDOW_TYPE,
         window_size=WINDOW_SIZE, window_stride=WINDOW_STRIDE, with_pca=False, pca_components=PCA_COMPONENTS,
         show_plot_variance=False, dataset_eval=dataset_eval, dataset_test=dataset_test)
